...
function getHtmlElementsById() {
    ...
    editorStartBtn = getId('editorStartBtn')
...
function setButtonsToolTip() {
    ...
    setTippy(editorStartBtn, 'Start editor', 'right-start');
...
function handleButtonsRule() {
    ...
    elemDisplay(editorStartBtn, buttons.main.showEditorBtn);
...
async function loadRemoteMediaStream(stream, peers, peer_id) {
    ...
    const remoteEditorBtn = document.createElement('button');
    ...
    remoteEditorBtn.setAttribute('id', peer_id + '_editor');
    remoteEditorBtn.className = 'fas fa-upload';
    ...
    setTippy(remoteFileShareBtn, 'Editor', 'bottom');
    setTippy(remoteEditorBtn, 'Send file', 'bottom');
    ...
    remoteVideoNavBar.appendChild(remoteEditorBtn);
...
function setMyEditorBtn() {
    editorStartBtn.addEventListener('click', (e) => {
        showEditorBtn();
    });
}
...
function handlePeerEditorBtn(peer_id) {
    let peerEditorBtn = getId(peer_id + '_shareFile');
    peerEditorBtn.onclick = () => {
        startEditor(peer_id);
    };
}
...
function showEditorBtn(peer_id, brodcast = false) {
